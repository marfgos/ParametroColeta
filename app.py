...
# Esta linha é importante para garantir que o log_stream seja o único destino de logs em reruns
...
st.title("📦 Roteirização com Regras de Substituição") # Título pode vir depois do set_page_config
    ...
    if df_grupos_final.empty:
        ...
        with st.spinner("Preparando roteirização..."):
            ...
            for i, municipio in enumerate(municipios):
                ...
                # logger.debug(f"Progresso: {progress}% para {municipio}") # Debug logs são muito verbosos para o stream principal
